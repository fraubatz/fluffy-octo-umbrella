...
public class DlgTextInput extends Dialog
{
	private Dimension _parentFrameSize;
	private Dimension _dialogFrameSize;
	private Point	  _parentFrameLocation;

	public DlgTextInput(Frame f, boolean mode)
	{
		super (f, "Texteingabe", mode);
		Panel pnl = new DlgTextInputPnl(this, (SmMainFrame) f);
		add ("Center", pnl);
		setResizable (false);
