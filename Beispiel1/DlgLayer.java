...
public class DlgLayer extends Dialog
{
	private Dimension _parentFrameSize;
	private Dimension _dialogFrameSize;
	private Point	  _parentFrameLocation;

	public DlgLayer(Frame f,boolean mode)
	{
		super (f, "Layer ein/ausschalten", mode);
		Panel pnl = new DlgLayerPnl(this, (SmMainFrame) f);
		add ("Center", pnl);
		setResizable (false);
